...
public class TestBase {
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:/Users/wcg112/eclipse-workspace/ToolsQA/src"
	...
	public static void initialization()
	{
		...
		if(browserName.equals("Chrome")){
			...
			System.setProperty("webdriver.gecko.driver", "C:/Users/wcg112/eclipse-workspace/ToolsQA/Drivers/geckodriver.exe");
